<%-- 
    Document   : registrationtraveler
    Created on : Nov 2, 2019, 8:16:05 PM
    Author     : root
--%>
    ...
    <head>
        ...
        <style>
            ...
            body{
                ...
                background-image:url('assets/img/szadelo2.jpeg');
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="./reg" method="post">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input id="avalink" type="hidden" value="./assets/avatar.png" name="avatar_hyperlink">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-center links">
                            Already have an account?<a href="./login">Log in As Traveler<br> </a>
                        </div>
